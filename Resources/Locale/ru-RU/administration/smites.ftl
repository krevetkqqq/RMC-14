...
admin-smite-charlie-prompt = Вы ощущаете странные чувства.
...
admin-smite-charlie-description = Насильно превращает цель в осбого бойца чарли. Это настоящая пытка для некоторых игроков, используйте её с умом.
