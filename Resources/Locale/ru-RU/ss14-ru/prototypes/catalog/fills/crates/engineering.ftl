...
ent-CrateTurretMarine = ящик с турелями
    .desc = Набор с турелями.На этикетке мелким текстом написано что производитель не несёт ответственности за несчастные случаи с ними.
