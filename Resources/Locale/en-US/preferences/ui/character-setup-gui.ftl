...
character-setup-gui-create-new-character-button = Добавить слот.....
character-setup-gui-create-new-character-button-tooltip = Максимум {$maxCharacters} слотов.
...
character-setup-gui-save-panel-title = Не сохранённые изменения персонажа
